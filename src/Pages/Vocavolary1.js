            ...
            >
                {slides.map((item, index) => (
                    <SwiperSlide key={index}>
                        <img src={item.image} alt={item.english} style={{ width: "100%", height: "150px", objectFit: "contain" }} />
                        <h2 style={{ fontSize: "1.5rem", marginTop: "10px" }}>{item.japanese}</h2>
